...
GOOGLE_API_KEYS=st.sidebar.text_input("GOOGLE_API_KEY",type="password")
TAVILY_API_KEYS=st.sidebar.text_input("TAVILY_API_KEY",type="password")
...
def generate_image(img_prompt,slide_no = 1):
  """This function helps to generate
  image using free api, with giiven
